...
# app.py (Streamlit WASH Dashboard) - Added 3.1.3 Basic sanitation gained
...
def load_data(path):
    ...
    df = robust_rename_columns(df, {
        ...
        'additional toilets built': [
            'additional toilets built',
            'no. of additional toilets built',
            '# of additional toilets built',
            'additional toilets constructed',
            'new toilets built',
            'toilets built (additional)'
        ],
