...
# -------------------------------------------------
# Sidebar Navigation (요청사항 반영 완료)
# -------------------------------------------------
st.sidebar.title("🧭 Navigation")
main_menu = st.sidebar.selectbox(
    "Select Team:",
    ["3.1 Siddhi Shrestha", "3.2 Dandi Ram", "3.3 Arinita", "Progress against target"]  # ✅ 이름 변경
)
...
if main_menu == "3.1 Siddhi Shrestha":
    page = st.sidebar.radio(
        ...
        [
            ...
            # ✅ 3.1.7 제거: "3.1.7 End Year Progress against Annual target "
        ]
    )
...
try:
    if main_menu == "3.1 Siddhi Shrestha":
        ...
        # ✅ 선택한 Field Office & Indicator 를 제목에 표기
        display_coming_soon(f"3.3 Arinita - {arinita_office} - {arinita_indicator}")

    elif main_menu == "Progress against target":  # ✅ 이름 변경 반영
