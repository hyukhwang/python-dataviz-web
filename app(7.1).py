...
if main_menu == "3.1 Siddhi Shrestha":
    page = st.sidebar.radio(
        ...
        [
            ...
            # 요청사항 3: 3.1.7 End Year Progress against Annual target 삭제 (이미 제거됨)
        ]
    )

elif main_menu == "3.2 Dandi Ram":
    # 요청사항 2: Select Indicator 추가
