...
# app.py (Streamlit WASH Dashboard) - based on app(6.8).py with Select Team updates
...
# -------------------------------------------------
# Sidebar Navigation (UPDATED per your requests)
# -------------------------------------------------
...
main_menu = st.sidebar.selectbox(
    ...
    [
        ...
        "3.2 Dandi Ram",
        "3.3 Arinita",
        # ▼ Arinita Field Offices moved into Select Team (simple labels)
        "Janakpur",
        "Dhangadi",
        "Bhairahawa",
        "Surkhet",
...
# 3.3 Arinita + FO labels: show Arinita indicators
...
# -------------------------------------------------
# Sidebar - File config (unchanged logic)
# -------------------------------------------------
...
# -------------------------------------------------
# Nepal Field Office Coordinates (unchanged)
# -------------------------------------------------
OFFICE_COORDINATES = {
...
# -------------------------------------------------
# Main app logic (unchanged features + updated nav)
# -------------------------------------------------
try:
    if main_menu == "3.1 Siddhi Shrestha":
        # -------------------- 3.1.1 --------------------
    ...
    # 3.3 Arinita & FO (simple labels + indicator in title)
    elif main_menu in ["3.3 Arinita", "Janakpur", "Dhangadi", "Bhairahawa", "Surkhet"]:
    ...
    # ✅ Fixed: only a single st.error line (no duplicated tokens)
    st.error(f"❌ Error loading data or    st.error(f"❌ Error loading data or rendering dashboard: {str(e)}")
    # import traceback
