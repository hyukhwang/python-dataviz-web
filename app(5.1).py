...
# Function to display "Coming Soon" page
        ...
        if page == "3.1.1 Safe water access":
            ...
            if view_mode == "📊 Office Summary Dashboard":
                ...
                st.download_button(
                    ...
                    data=csv,
                    file_name="wash_beneficiaries_2025.csv",
                    mime="text/csv"
                )
            ...
            # PAGE 2: Nepal Map & Palika Analysis
                ...
                st.title("💧 WASH Program Dashboard - Safe Water Access")
                st.markdown("### Total Beneficiaries by Field Office and Palika (2025)")
                st.markdown("---")
                ...
                with tab1:
                    ...
                    st.markdown("**Click on the markers to see detailed information**")
                ...
                with tab2:
                    st.subheader("📊 Office-Level Analysis")
                ...
                with tab3:
                    ...
                    top_10 = filtered_palika_df.head(10)
                    
                    if len(top_10) > 0:
                        fig3, ax3 = plt.subplots(figsize=(12, 6))
                        colors_list = [OFFICE_COORDINATES[office]['color'] for office in top_10['Office']]
                    ...
                    office_name_clean = selected_office.replace(' ', '_')
                    st.download_button(
                        label="📥 Download Palika Data as CSV",
                        data=csv,
                        file_name=f"palika_beneficiaries_{office_name_clean}.csv",
                        mime="text/csv"
                    )
