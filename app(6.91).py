...
# -------------------------------------------------
# Main app logic (CLEAN INDENTATION)
# -------------------------------------------------
try:
    if main_menu == "3.1 Siddhi Shrestha":
        # -------------------- 3.1.1 --------------------
        ...
        # -------------------- 3.1.3 --------------------
            ...
            # 다른 3.1 인디케이터는 'Under Development' 표시
    ...
    st.error(f"❌ Error loading data or rendering dashboard: {str    st.error(f"❌ Error loading data or rendering dashboard: {str(e)}")
    # import traceback
