...
main_menu = st.sidebar.selectbox(
    ...
    [
        ...
        "3.2 Dandi Ram",
        "3.3 Arinita",
        # ▼ Field Office 4개를 Select Team으로 이동
        "3.3 Arinita - Janakpur",
        "3.3 Arinita - Dhangadi",
        "3.3 Arinita - Bhairahawa",
        "3.3 Arinita - Surkhet",
        # ▼ 이름 변경
...
# 3.1 Siddhi - 기존 옵션 유지하되 3.1.7 삭제
if main_menu == "3.1 Siddhi Shrestha":
    page = st.sidebar.radio(
        ...
        [
            ...
            # "3.1.7 End Year Progress against Annual target "  # ← 완전히 제거
        ]
    )
...
# 3.3 Arinita 및 FO 변형: Indicator 라디오 추가
elif main_menu in [
    "3.3 Arinita",
    "3.3 Arinita - Janakpur",
    "3.3 Arinita - Dhangadi",
    ...
    # 선택된 Field Office 문자열 파싱 (기본: None)
    selected_fo = None
    if " - " in main_menu:
...
try:
    ...
    # 3.3 Arinita 및 FO 변형: Indicator 선택값 반영하여 'Under Development'
    elif main_menu in [
        "3.3 Arinita",
        "3.3 Arinita - Janakpur",
        "3.3 Arinita - Dhangadi",
